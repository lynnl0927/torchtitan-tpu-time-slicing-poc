...
def maybe_enable_profiling(
    ...
    *,
    ...
    if enable_profiling:
        ...
        accelerator_profiled = None
        if torch.cuda.is_available():
            accelerator_profiled = torch.profiler.ProfilerActivity.CUDA
        elif torch.xpu.is_available():
            accelerator_profiled = torch.profiler.ProfilerActivity.XPU
        ...
        class MemoryProfiler:
            ...
            def step(self, exit_ctx: bool = False):
                ...
                with open(output_file, "wb") as output:
                    pickle.dump(device_module.memory._snapshot(), output)  # pytype: disable=undefined-variable
                logger.info(
