...
class AFMTextV7ModelArgs(BaseModel.Config):
  ...
  def update_from_config(
    ...
    if isinstance(trainer_config, TPUJobConfig):
      ...
      self.lora_dtype = trainer_config.lora.lora_dtype
  ...
  def get_nparams_and_flops(
    ...
    Follows the same formula as get_dense_model_nparams_and_flops:
      flops_per_token = 6 * (N - N_emb) + 6 * num_layers * num_heads * head_dims
      * seq_len
