...
- Automatic mixed precision (AMP) is enabled by default in `afmv7_3b.toml` (`enable_amp = true`) and is load-bearing for full fine-tuning.
...
- Average TPS/chip: **11,965**
- Average MFU: **36.57%**
- Total TPS (8 chips): 95,721
...
- Average TPS (excl. 10 warmup steps): **7,974**
- Average MFU: **24.37%**
- Total TPS (8 chips): 63,792
