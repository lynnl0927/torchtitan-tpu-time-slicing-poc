...
- For compile, we drop the local batch size to 2 on DDP and 3 on FSDP to prevent OOM.
...
- Average TPS (excl. 10 warmup steps): 9642
- Average MFU: 23.80%

## FSDP w/ torch.compile and AMP
...
- Average TPS (excl. 10 warmup steps): 9,063
- Average MFU: 22.37%
...
- Average TPS (excl. 10 warmup steps): 7213
- Average MFU: 17.81%