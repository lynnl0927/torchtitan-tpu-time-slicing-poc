...
# from torch.nn.attention.varlen import varlen_attn - not yet available in g3
...
class VarlenAttentionWrapper(torch.nn.Module):
    _compiled_varlen_attn: ClassVar[Callable] = None  # not yet available in g3
...
from torchtitan.experiments.tpu import workarounds as tpu_workarounds
    ...
    def __init__(self) -> None:
        ...
        if not self.sdpa_backends:
            self.sdpa_backends = [
                ...
                # SDPBackend.FLASH_ATTENTION, # doesn't work in g3 b/431285931
                SDPBackend.MATH,
            ]
